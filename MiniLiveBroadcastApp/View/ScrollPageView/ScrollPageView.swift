...
extension ScrollPageView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell =
            (tableView.dequeueReusableCell(withIdentifier: .PageCellIdentifier, for: indexPath)
                as! ScrollPageViewCell)
...
class ScrollPageView: UITableView {
    ...
    func setPublicBoard(rootVC: UIViewController) {
        ...
        publicBoardView = UIHostingController(
            rootView: PublicBoardView(
                model: viewModel,
